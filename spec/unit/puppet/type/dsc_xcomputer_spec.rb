...
describe Puppet::Type.type(:dsc_xcomputer) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xcomputer[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xcomputer[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  # TODO: this test is not right yet
  it 'should accept array for dsc_unjoincredential' do
    dsc_xcomputer[:dsc_unjoincredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xcomputer[:dsc_unjoincredential]).to eq({"user"=>"user", "password"=>"password"})
  end
