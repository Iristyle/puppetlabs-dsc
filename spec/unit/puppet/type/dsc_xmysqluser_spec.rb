...
describe Puppet::Type.type(:dsc_xmysqluser) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xmysqluser[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xmysqluser[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  # TODO: this test is not right yet
  it 'should accept array for dsc_connectioncredential' do
    dsc_xmysqluser[:dsc_connectioncredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xmysqluser[:dsc_connectioncredential]).to eq({"user"=>"user", "password"=>"password"})
  end
