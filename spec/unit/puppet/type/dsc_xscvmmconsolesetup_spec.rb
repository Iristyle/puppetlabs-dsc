...
describe Puppet::Type.type(:dsc_xscvmmconsolesetup) do
  ...
  it 'should accept array for dsc_setupcredential' do
    dsc_xscvmmconsolesetup[:dsc_setupcredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xscvmmconsolesetup[:dsc_setupcredential]).to eq({"user"=>"user", "password"=>"password"})
  end
