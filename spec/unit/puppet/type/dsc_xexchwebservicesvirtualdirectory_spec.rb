...
describe Puppet::Type.type(:dsc_xexchwebservicesvirtualdirectory) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchwebservicesvirtualdirectory[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchwebservicesvirtualdirectory[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
