...
describe Puppet::Type.type(:dsc_xexchdatabaseavailabilitygroup) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchdatabaseavailabilitygroup[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchdatabaseavailabilitygroup[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  it 'should accept string-like int for dsc_replicationport' do
    dsc_xexchdatabaseavailabilitygroup[:dsc_replicationport] = '16'
    expect(dsc_xexchdatabaseavailabilitygroup[:dsc_replicationport]).to eq(16)
  end
