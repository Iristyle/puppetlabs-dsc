...
describe Puppet::Type.type(:dsc_xscspfserverupdate) do
  ...
  it 'should accept array for dsc_setupcredential' do
    dsc_xscspfserverupdate[:dsc_setupcredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xscspfserverupdate[:dsc_setupcredential]).to eq({"user"=>"user", "password"=>"password"})
  end
