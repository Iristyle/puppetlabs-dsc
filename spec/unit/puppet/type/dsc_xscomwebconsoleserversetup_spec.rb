...
describe Puppet::Type.type(:dsc_xscomwebconsoleserversetup) do
  ...
  it 'should accept array for dsc_setupcredential' do
    dsc_xscomwebconsoleserversetup[:dsc_setupcredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xscomwebconsoleserversetup[:dsc_setupcredential]).to eq({"user"=>"user", "password"=>"password"})
  end
