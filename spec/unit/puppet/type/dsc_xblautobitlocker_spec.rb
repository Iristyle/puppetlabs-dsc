...
describe Puppet::Type.type(:dsc_xblautobitlocker) do
  ...
  it 'should accept array for dsc_password' do
    dsc_xblautobitlocker[:dsc_password] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xblautobitlocker[:dsc_password]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  it 'should accept array for dsc_pin' do
    dsc_xblautobitlocker[:dsc_pin] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xblautobitlocker[:dsc_pin]).to eq({"user"=>"user", "password"=>"password"})
  end
