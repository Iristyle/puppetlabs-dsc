...
describe Puppet::Type.type(:dsc_xadcscertificationauthority) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xadcscertificationauthority[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xadcscertificationauthority[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  # TODO: this test is not right yet
  it 'should accept array for dsc_certfilepassword' do
    dsc_xadcscertificationauthority[:dsc_certfilepassword] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xadcscertificationauthority[:dsc_certfilepassword]).to eq({"user"=>"user", "password"=>"password"})
  end
