...
describe Puppet::Type.type(:dsc_xexchowavirtualdirectory) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchowavirtualdirectory[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchowavirtualdirectory[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
