...
describe Puppet::Type.type(:dsc_xscdpmconsolesetup) do
  ...
  it 'should accept array for dsc_setupcredential' do
    dsc_xscdpmconsolesetup[:dsc_setupcredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xscdpmconsolesetup[:dsc_setupcredential]).to eq({"user"=>"user", "password"=>"password"})
  end
