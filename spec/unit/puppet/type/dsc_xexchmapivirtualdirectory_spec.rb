...
describe Puppet::Type.type(:dsc_xexchmapivirtualdirectory) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchmapivirtualdirectory[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchmapivirtualdirectory[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
