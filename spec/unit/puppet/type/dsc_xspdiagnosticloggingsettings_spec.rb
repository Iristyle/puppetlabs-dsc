...
describe Puppet::Type.type(:dsc_xspdiagnosticloggingsettings) do
  ...
  it 'should accept array for dsc_installaccount' do
    dsc_xspdiagnosticloggingsettings[:dsc_installaccount] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xspdiagnosticloggingsettings[:dsc_installaccount]).to eq({"user"=>"user", "password"=>"password"})
  end
