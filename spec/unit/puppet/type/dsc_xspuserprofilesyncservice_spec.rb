...
describe Puppet::Type.type(:dsc_xspuserprofilesyncservice) do
  ...
  it 'should accept array for dsc_farmaccount' do
    dsc_xspuserprofilesyncservice[:dsc_farmaccount] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xspuserprofilesyncservice[:dsc_farmaccount]).to eq({"user"=>"user", "password"=>"password"})
  end
  ...
  it 'should accept array for dsc_installaccount' do
    dsc_xspuserprofilesyncservice[:dsc_installaccount] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xspuserprofilesyncservice[:dsc_installaccount]).to eq({"user"=>"user", "password"=>"password"})
  end
