...
describe Puppet::Type.type(:dsc_xexchdatabaseavailabilitygroupnetwork) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchdatabaseavailabilitygroupnetwork[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchdatabaseavailabilitygroupnetwork[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
