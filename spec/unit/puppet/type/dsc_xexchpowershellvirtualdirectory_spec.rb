...
describe Puppet::Type.type(:dsc_xexchpowershellvirtualdirectory) do
  ...
  it 'should accept array for dsc_credential' do
    dsc_xexchpowershellvirtualdirectory[:dsc_credential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xexchpowershellvirtualdirectory[:dsc_credential]).to eq({"user"=>"user", "password"=>"password"})
  end
