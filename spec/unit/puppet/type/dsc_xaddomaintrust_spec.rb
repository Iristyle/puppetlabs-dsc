...
describe Puppet::Type.type(:dsc_xaddomaintrust) do
  ...
  it 'should accept array for dsc_targetdomainadministratorcredential' do
    dsc_xaddomaintrust[:dsc_targetdomainadministratorcredential] = {"user"=>"user", "password"=>"password"}
    expect(dsc_xaddomaintrust[:dsc_targetdomainadministratorcredential]).to eq({"user"=>"user", "password"=>"password"})
  end
