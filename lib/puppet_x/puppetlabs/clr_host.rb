...
module PuppetX
  module Dsc
    class CLRHost
      ...
      # TODO: ideas on how to finish this up
      # TODO: compile some .NET on the fly to an asm with csc.exe
      # TODO: make the method int start(string args)
      # TODO: method should start a thread, return the HANDLE to a named pipe
      # TODO: to be used for further IPC
