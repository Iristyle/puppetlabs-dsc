...
Puppet::Type.newtype(:dsc_waitforsome) do
  ...
  @doc = %q{
    The DSC WaitForSome resource type.
    Originally generated from the following schema.mof file:
      import/dsc_resources/PSDesiredStateConfiguration/DSCResources/MSFT_WaitForSome/MSFT_WaitForSome.schema.mof
  }
  ...
  newparam(:dscmeta_resource_friendly_name) do
    defaultto "WaitForSome"
  end

  newparam(:dscmeta_resource_name) do
    defaultto "MSFT_WaitForSome"
  end
  ...
  # IsMandatory:  False
  # Values:       None
  newparam(:dsc_nodecount) do
    desc "Number of machines need to succeed."
    validate do |value|
