...
Puppet::Type.newtype(:dsc_waitforall) do
  ...
  @doc = %q{
    The DSC WaitForAll resource type.
    Originally generated from the following schema.mof file:
      import/dsc_resources/PSDesiredStateConfiguration/DSCResources/MSFT_WaitForAll/MSFT_WaitForAll.schema.mof
  }
  ...
  newparam(:dscmeta_resource_friendly_name) do
    defaultto "WaitForAll"
  end

  newparam(:dscmeta_resource_name) do
    defaultto "MSFT_WaitForAll"
  end
