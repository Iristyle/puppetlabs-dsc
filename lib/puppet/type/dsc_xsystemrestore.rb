...
Puppet::Type.newtype(:dsc_xsystemrestore) do
  ...
  @doc = %q{
    ...
    Originally generated from the following schema.mof file:
      import/dsc_resources/xWindowsRestore/DSCResources/xSystemRestore/xSystemRestore.schema.mof
  }
