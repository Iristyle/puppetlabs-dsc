...
Puppet::Type.newtype(:dsc_xscvmmmanagementserverupdate) do
  ...
  @doc = %q{
    The DSC xSCVMMManagementServerUpdate resource type.
    Originally generated from the following schema.mof file:
      import/dsc_resources/xSCVMM/DSCResources/MSFT_xSCVMMManagementServerUpdate/MSFT_xSCVMMManagementServerUpdate.schema.mof
  }
  ...
  newparam(:dscmeta_resource_friendly_name) do
    defaultto "xSCVMMManagementServerUpdate"
  end

  newparam(:dscmeta_resource_name) do
    defaultto "MSFT_xSCVMMManagementServerUpdate"
  end
