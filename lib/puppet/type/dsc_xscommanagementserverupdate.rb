...
Puppet::Type.newtype(:dsc_xscommanagementserverupdate) do
  ...
  @doc = %q{
    The DSC xSCOMManagementServerUpdate resource type.
    Originally generated from the following schema.mof file:
      import/dsc_resources/xSCOM/DSCResources/MSFT_xSCOMManagementServerUpdate/MSFT_xSCOMManagementServerUpdate.schema.mof
  }
  ...
  newparam(:dscmeta_resource_friendly_name) do
    defaultto "xSCOMManagementServerUpdate"
  end

  newparam(:dscmeta_resource_name) do
    defaultto "MSFT_xSCOMManagementServerUpdate"
  end
