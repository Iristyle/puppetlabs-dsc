...
Puppet::Type.newtype(:dsc_xscomconsoleupdate) do
  ...
  @doc = %q{
    ...
    Originally generated from the following schema.mof file:
      import/dsc_resources/xSCOM/DSCResources/MSFT_xSCOMConsoleUpdate/MSFT_xSCOMConsoleUpdate.schema.mof
  }
  ...
  newparam(:dscmeta_resource_friendly_name) do
    defaultto "xSCOMConsoleUpdate"
  end

  newparam(:dscmeta_resource_name) do
    defaultto "MSFT_xSCOMConsoleUpdate"
  end
